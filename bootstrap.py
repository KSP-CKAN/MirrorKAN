...
def main():
    ...
    os.system('python ' + generate_scripts_path + ' --clean --build-ckan --update-ckan-meta --update-netkan --push-ckan-meta --update-mirrorkan --generate-index > ' + os.path.join(root, 'all.sh'))
